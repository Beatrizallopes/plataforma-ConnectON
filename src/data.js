...
const roomsList = [
    { name: "Escritório 1", qtyMod:4, color:"#80908A",isFavorite:true,cod:"1A",devices:[devicesList[0],devicesList[2]]},
    { name: "Escritório 2", qtyMod:2, color:"#80908A",isFavorite:true,cod:"1B",devices:[devicesList[3]]},
    { name: "Escritório 3", qtyMod:6, color:"#80908A",isFavorite:true,cod:"1C", devices:[devicesList[1],devicesList[2]]},
    { name: "Descompressão", qtyMod:2, color:"#6888CF",isFavorite:false,cod:"1D",devices:[devicesList[0]]},
    { name: "RH", qtyMod:2, color:"#6888CF",isFavorite:true,cod:"1E",devices:[devicesList[0],devicesList[1],devicesList[2]]},
    { name: "Estacionamento", qtyMod:0, color:"#CD9C44",isFavorite:true,cod:"1F",devices:[devicesList[4],devicesList[5]]},
    { name: "Copa", qtyMod:3, color:"#CD9C44",isFavorite:true,cod:"1G",devices:[devicesList[6]]},
    { name: "Brahma", qtyMod:1, color:"#CD9C44",isFavorite:false,cod:"1H",devices:[devicesList[5],devicesList[1],devicesList[2]]},
];
