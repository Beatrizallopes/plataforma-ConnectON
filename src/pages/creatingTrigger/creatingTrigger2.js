        ...
        <Modal animationType="slide" transparent={true} visible={true} >
          <View style={styles.centeredView}>
            <View style={styles.selectAmbModal}>
                ...
                <Text style={[showText(trigger.roomsSel),styles.instruction]}>Selecione os ambientes que seu gatilho irá controlar.</Text>
                ...
                <TouchableWithoutFeedback onPress={() => navigation.navigate("Select Trigger Rooms",{trigger:trigger})}>
                  <View style={[buttonPosition(trigger.roomsSel),styles.buttonCreate]}>
                    <Text style={[styles.buttonText,{color:"#D66075"}]}>
                      <Image source={require('./../../images/icons/selecionarAmbientes.png')}></Image>  
